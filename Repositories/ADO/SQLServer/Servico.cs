...
namespace GWI.Repositories.ADO.SQLServer
{
    public class Servico
    {
            ...
            public Servico(string connectionString) //Quem invocar o construtor do repositório deve enviar a string de conexão.
            {
            ...
            public void add(Models.Servicos servico)
            {
                using (SqlConnection connection = new SqlConnection(this.connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        command.Parameters.Add(new SqlParameter("@título", System.Data.SqlDbType.VarChar)).Value = servico.sv_título;
                        command.Parameters.Add(new SqlParameter("@imagem", System.Data.SqlDbType.VarChar)).Value = servico.sv_imagem;
                        command.Parameters.Add(new SqlParameter("@descricao", System.Data.SqlDbType.VarChar)).Value = servico.sv_descrição;
